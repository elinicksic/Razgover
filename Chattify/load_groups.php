<?php
    ...
    echo "<div class='list-group'><a onclick='newgroup();' id='creategroup' class='list-group-item list-group-item-success group-listing'><i class='fas fa-plus'></i> Create a new group</a>";
